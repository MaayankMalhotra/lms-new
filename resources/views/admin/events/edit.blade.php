        ...
        <div class="mb-8 flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 flex items-center">
                    <i class="fas fa-calendar-alt mr-2"></i> Edit Event
                </h1>
                <p class="text-gray-500 mt-2">Update the event details.</p>
            </div>
                ...
                <div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            @endif
                            <p class="text-sm text-gray-600">Drag and drop a new image or <span
                    ...
                    <select name="category_id" id="category_id"
                        ...
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}"
                                {{ old('category_id', $event->category_id) == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                        @endforeach
                    </select>
                    @error('category_id')
                        <p class="text-red-500 text-sm mt-1 flex items-center">
