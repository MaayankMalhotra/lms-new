        ...
        <form action="{{ route('admin.job-roles.store') }}" method="POST" id="jobRoleForm" onsubmit="return handleFormSubmit()">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('title') border-red-500 @enderror" placeholder="e.g., Frontend Engineer">
                    @error('title')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="company_name" id="company_name" value="{{ old('company_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('company_name') border-red-500 @enderror" placeholder="e.g., Acme Corp">
                    @error('company_name')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="salary_package" id="salary_package" value="{{ old('salary_package') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('salary_package') border-red-500 @enderror" placeholder="e.g., ₹10 - 15 LPA">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="location" id="location" value="{{ old('location') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('location') border-red-500 @enderror" placeholder="e.g., Bengaluru (Hybrid)">
                    @error('location')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="apply_link" id="apply_link" value="{{ old('apply_link') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('apply_link') border-red-500 @enderror" placeholder="https://company.com/careers/role">
                    @error('apply_link')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="image_url" id="image_url" value="{{ old('image_url') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('image_url') border-red-500 @enderror" placeholder="Hero/brand image for this role">
                    @error('image_url')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="last_date_to_apply" id="last_date_to_apply" value="{{ old('last_date_to_apply') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('last_date_to_apply') border-red-500 @enderror">
                ...
                <div class="mb-4 md:col-span-2">
                    ...
                    <textarea name="suggestions" id="suggestions" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('suggestions') border-red-500 @enderror" placeholder="Any extra notes for candidates">{{ old('suggestions') }}</textarea>
                    @error('suggestions')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
