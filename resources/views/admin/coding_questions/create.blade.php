                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="relative">
                            ...
                            <textarea name="example_output_1"
                                      class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
                                      rows="3"
                                      placeholder="Enter example output 1">{{ old('example_output_1') }}</textarea>
                        ...
                        <div class="relative">
                            ...
                            <textarea name="example_output_2"
                                      class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
                                      rows="3"
                                      placeholder="Enter example output 2">{{ old('example_output_2') }}</textarea>
                        ...
                        <div class="relative">
                            ...
                            <textarea name="example_output_3"
                                      class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
                                      rows="3"
                                      placeholder="Enter example output 3">{{ old('example_output_3') }}</textarea>
