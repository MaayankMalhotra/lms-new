...
@section('content')
    ...
    <div class="px-4">
        <h1 class="section-title">Add Internship Details</h1>
        ...
        <form method="POST" action="{{ route('course.store.int') }}" enctype="multipart/form-data">
            @csrf
            <div class="form-grid">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="field-container">
                                ...
                                <select name="internship_id" id="internship_id" required>
                                    <option value="" disabled {{ old('internship_id') ? '' : 'selected' }}>Select an internship</option>
                                    @foreach($course_name as $course)
                                        <option value="{{ $course->id }}" {{ (string) old('internship_id') === (string) $course->id ? 'selected' : '' }}>
                                            {{ $course->name }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="collapsible-section full-width">
                    ...
                    <div class="collapsible-content">
                        ...
                        <div class="field-container full-width">
                            ...
                            <textarea name="instructor_info" rows="4" placeholder="Add instructor details">{{ old('instructor_info') }}</textarea>
                ...
                <!-- Submit Button -->
                <div class="field-container">
                    <button type="submit" class="button submit-button">Add Internship Detail</button>
                </div>
            </div>
        </form>
    </div>
