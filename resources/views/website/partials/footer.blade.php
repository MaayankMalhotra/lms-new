<footer class="bg-gray-900 text-white py-12">
  <div class="container mx-auto px-4">
    ...
    <div class="border-t border-gray-800 mt-8 pt-8 text-center md:text-left">
      ...
      <!-- ✅ Developer Credit -->
      <div class="mt-6 text-center text-gray-400 text-sm leading-relaxed">
        <p>
          Developed, Deployed, Maintained &amp; Upgraded by 
          <span class="font-semibold text-orange-500">Maayank Malhotra</span>
        </p>
        <p>
          📧 <a href="mailto:maayankmalhotra095@gmail.com" class="underline hover:text-orange-400">maayankmalhotra095@gmail.com</a> | 
          📞 <a href="tel:+918799730966" class="underline hover:text-orange-400">+91 8799730966</a>
        </p>
